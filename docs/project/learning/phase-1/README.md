...
| [walkthrough.py](walkthrough.py) | 同一份内容的纯 Python 版本 | `python docs/project/learning/phase-1/walkthrough.py` |
...
2. 运行同内容的纯 Python 版本：`python docs/project/learning/phase-1/walkthrough.py`；
...
python tools/check_notebook.py docs/project/learning/phase-1/walkthrough.ipynb
```
