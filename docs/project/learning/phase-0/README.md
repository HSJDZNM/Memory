...
| [walkthrough.py](walkthrough.py) | 同一份内容的纯 Python 版本 | `python docs/project/learning/phase-0/walkthrough.py` |
...
2. 运行同内容的纯 Python 版本：`python docs/project/learning/phase-0/walkthrough.py`；
...
python tools/check_notebook.py docs/project/learning/phase-0/walkthrough.ipynb
```
...
```powershell
python tools/run_notebook_in_kernel.py docs/project/learning/phase-0/walkthrough.ipynb
```
