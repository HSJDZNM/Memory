...
jupyter lab docs/project/learning/phase-5/walkthrough.ipynb

# 方式二：纯 Python（同内容，逐段打印）
python docs/project/learning/phase-5/walkthrough.py

# 方式三：不想装 Jupyter，只想确认它没坏
python tools/run_notebook_in_kernel.py docs/project/learning/phase-5/walkthrough.ipynb
```
