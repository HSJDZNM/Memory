...
source_url: "https://docs.gitlab.com/development/jh_features_review/"
section: "development/jh_features_review"
...
We have two kinds of changes related to JH:
  ...
  * Outside `jh/`
    ...
    * Database migrations and database schema changes which are required to support running JH edition. See [JiHu guidelines for database changes](https://handbook.gitlab.com/handbook/ceo/chief-of-staff-team/jihu-support/jihu-database-change-process/) for details.
...
See [Extend CE features with EE backend code](https://docs.gitlab.com/development/ee_features/#extend-ce-features-with-ee-backend-code) for more details.
...
See [Guidelines for implementing Enterprise Edition features](https://docs.gitlab.com/development/ee_features/) for general guidance.
