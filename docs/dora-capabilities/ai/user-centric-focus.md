...
source_url: "https://dora.dev/capabilities/user-centric-focus/"
section: "ai"
...
Our research reveals a stark contrast in how AI impacts teams based on their focus:
  ...
  * **The “Feature factory” trap:** Conversely, adopting AI without a user-centric focus can actually _harm_ team performance. If a team is optimizing for output (features shipped) rather than outcomes (user value), AI can accelerate the production of low-value software, leading to high activity but low impact.
...
An emerging paradigm for aligning AI with user needs is **spec-driven development (SDD)**. In this approach, developers refine user needs and constraints into detailed documentation (specs) _before_ writing code. This documentation becomes the source of truth for AI agents, ensuring that generated code is constrained by actual user requirements rather than just generic patterns.
