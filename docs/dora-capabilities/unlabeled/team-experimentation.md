...
source_url: "https://dora.dev/capabilities/team-experimentation/"
section: "unlabeled"
role: "能力文档 · 站点未标注模型归属"
...
Team experimentation is part of lean product management. This approach is often used in combination with capabilities like [visibility of work in the value stream](work-visibility-in-value-stream.md), [working in small batches](../core/working-in-small-batches.md), and [visibility into customer feedback](customer-feedback.md). These capabilities predict software delivery performance and organizational performance.

## How to implement team experimentation

[DORA research](https://dora.dev) identifies three key components to team experimentation that drive software delivery performance:
