...
source_url: "https://dora.dev/capabilities/proactive-failure-notification/"
section: "unlabeled"
role: "能力文档 · 站点未标注模型归属"
...
Configure alerts to notify your key teams when something goes wrong in your systems early, long before it moves to the Network Operations Center (NOC) or to a customer. Tactics include:
...
## What’s next
  ...
  * Learn more about generating alerts in [Monitoring and observability](../core/monitoring-and-observability.md).
