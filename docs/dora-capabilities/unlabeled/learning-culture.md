...
source_url: "https://dora.dev/capabilities/learning-culture/"
section: "unlabeled"
role: "能力文档 · 站点未标注模型归属"
...
Research from the [DORA](https://dora.dev) team shows that an organizational culture that values learning contributes to software delivery performance with the following:
