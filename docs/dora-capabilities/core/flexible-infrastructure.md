...
source_url: "https://dora.dev/capabilities/flexible-infrastructure/"
section: "core"
...
> Flexible infrastructures lead to 30% higher organizational performance. ([Accelerate State of DevOps 2023](https://dora.dev/research/2023/dora-report/))
...
The [2019 State of DevOps Report](https://dora.dev/research/2019/dora-report/2019-dora-accelerate-state-of-devops-report.pdf) found that only 29% of people who claim to have adopted cloud technologies agreed or strongly agreed that they met all five of the characteristics defined above. In both [2018](https://dora.dev/research/2018/) and [2019](https://dora.dev/research/2019/), DORA’s research found that elite performers were more than 23 times more likely to have met all five essential cloud characteristics than low performers. This may explain why teams and executives who claim to have adopted cloud computing technologies also express frustration at not reaping the expected results.
...
When organizations continue to use traditional data center practices and processes to manage their infrastructure, they can’t achieve the expected benefits, which, according to DORA’s research, include:
  ...
  * Improved cost visibility: in [2019](https://dora.dev/research/2019/), we found that respondents who met all essential cloud characteristics are 2.6 times more likely to be able to accurately estimate the cost to operate software. They are also twice as likely to be able to easily identify their most operationally expensive applications.
...
The most crucial consideration is whether your cloud deployment has actually helped your organization achieve more [rapid, reliable releases](continuous-delivery.md), and higher levels of availability, [velocity, and reliability](https://dora.dev/quickcheck/).

### The platform foundation

Flexible infrastructure is the underlying engine that powers successful [platform engineering](../ai/platform-engineering.md).
...
> Organizations may be better off staying in the data center if they are not willing to radically transform their application or service. ([Accelerate State of DevOps 2024](https://dora.dev/research/2024/dora-report/))
...
Organizations must overcome several obstacles on this journey, including:
  ...
  * Enabling operations to move to modern [Site Reliability Engineering](https://landing.google.com/sre/) (SRE) and [platform engineering](../ai/platform-engineering.md) practices, including deploying infrastructure as code as a replacement for manual ticket-based configuration management
...
Overcoming these obstacles requires a [substantial change program](../guides/how-to-transform.md). It is essential to prioritize the human element — allocating dedicated budget and time for continuous learning — alongside sustained investment and collaboration between people at every level of the organization.
...
Read more about cloud and flexible infrastructure in the following publications:
  ...
  * [Accelerate State of DevOps 2024](https://dora.dev/research/2024/dora-report/)
  * [Accelerate State of DevOps 2023](https://dora.dev/research/2023/dora-report/)
  * [2022 Accelerate State of DevOps Report](https://dora.dev/research/2022/dora-report/)
  * [Accelerate State of DevOps 2021](https://dora.dev/research/2021/dora-report/)
  * [Accelerate State of DevOps 2019](https://dora.dev/research/2019/dora-report/)
  * [Accelerate: State of DevOps 2018](https://dora.dev/research/2018/)

## What’s next

  * Take the [DORA quick check](https://dora.dev/quickcheck/) to understand your team’s software delivery performance.
