...
source_url: "https://dora.dev/capabilities/generative-organizational-culture/"
section: "core"
...
Research from [a large two-year study at Google](https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html) found similar results: that high performing teams need a culture of trust and [psychological safety](https://en.wikipedia.org/wiki/Psychological_safety), meaningful work, and clarity. In the [2019 State of DevOps Report](https://dora.dev/research/2019/dora-report/2019-dora-accelerate-state-of-devops-report.pdf) further analysis shows that a culture of psychological safety is predictive of software delivery performance, organizational performance, and productivity.
...
## What’s next
  ...
  * Read [A typology of organisational culture](https://qualitysafety.bmj.com/content/13/suppl_2/ii22.short), by Ron Westrum.
