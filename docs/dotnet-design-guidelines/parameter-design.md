...
source_url: "https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/parameter-design/"
role: "指南文档 · Parameter design"
why: "上游目录路径：Framework design guidelines > Member design guidelines > Parameter design（同级第 8 篇）"
...
For example, suppose you want to design a method that enumerates a collection and prints each item to the console. Such a method should take [IEnumerable](https://learn.microsoft.com/en-us/dotnet/api/system.collections.ienumerable) as the parameter, not [ArrayList](https://learn.microsoft.com/en-us/dotnet/api/system.collections.arraylist) or [IList](https://learn.microsoft.com/en-us/dotnet/api/system.collections.ilist), for example.
...
✔️ DO validate arguments passed to public, protected, or explicitly implemented members. Throw [System.ArgumentException](https://learn.microsoft.com/en-us/dotnet/api/system.argumentexception), or one of its subclasses, if the validation fails.
...
✔️ DO throw [ArgumentNullException](https://learn.microsoft.com/en-us/dotnet/api/system.argumentnullexception) if a null argument is passed and the member does not support null arguments.
...
❌ DO NOT use [Enum.IsDefined](https://learn.microsoft.com/en-us/dotnet/api/system.enum.isdefined) for enum range checks.
...
Members that can take a variable number of arguments are expressed by providing an array parameter. For example, [String](https://learn.microsoft.com/en-us/dotnet/api/system.string) provides the following method:
...
A user can then call the [String.Format](https://learn.microsoft.com/en-us/dotnet/api/system.string.format) method, as follows:
...
_源站标注：Last updated on 2021-11-30_
