...
source_url: "https://google.github.io/eng-practices/review/reviewer/navigate.html"
source_repo_path: "master/review/reviewer/navigate.md"
...
## Summary
Now that you know [what to look for](looking-for.md), what’s the most efficient way to manage a review that’s spread across multiple files?
  1. Does the change make sense? Does it have a good [description](../developer/cl-descriptions.md)?
