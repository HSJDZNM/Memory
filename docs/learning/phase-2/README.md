...
| [walkthrough.py](walkthrough.py) | 同一份内容的纯 Python 版本 | `python docs/learning/phase-2/walkthrough.py` |
...
2. 运行同内容的纯 Python 版本：`python docs/learning/phase-2/walkthrough.py`；
...
notebook 由 `tools/build_learning_notebook.py` 生成，**不要手改 .ipynb**：
    ...
    python tools/check_notebook.py docs/learning/phase-2/walkthrough.ipynb

生成器会从**两个工作目录**（仓库根、`docs/learning/phase-2/`）各跑一遍全部代码单元，
