...
python tools/run_notebook_in_kernel.py docs/learning/phase-7/walkthrough.ipynb
```
...
2. 从仓库根与 `docs/learning/phase-7/` **各跑一遍全部代码单元**；
...
提交前跑 `python tools/check_notebook.py docs/learning/phase-7/walkthrough.ipynb`。
