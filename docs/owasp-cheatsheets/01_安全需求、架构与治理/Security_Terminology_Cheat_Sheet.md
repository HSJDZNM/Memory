...
crosswalk: ASVS V1 V6 V8 V11 V15
-->
...
## Table of Contents
  * [Data Handling: Encoding, Escaping, Sanitization, and Serialization](Security_Terminology_Cheat_Sheet.md#data-handling-encoding-escaping-sanitization-and-serialization)
  * [Cryptography: Encryption, Hashing, and Signatures](Security_Terminology_Cheat_Sheet.md#cryptography-encryption-hashing-and-signatures)
  * [Identity: Authentication and Authorization](Security_Terminology_Cheat_Sheet.md#identity-authentication-and-authorization)
  * [Federated Identity Terms](Security_Terminology_Cheat_Sheet.md#federated-identity-terms)
  * [References](Security_Terminology_Cheat_Sheet.md#references)
...
**Definition:** Using asymmetric cryptography to provide proof of the origin and integrity of a message.
  ...
  * **Mechanism:** The sender signs a hash of the message with their _private key_ ; the receiver verifies it with the sender's _public key_.
...
**Definition:** The process of verifying what a user has permission to do.
  ...
  * **Security Context:** Occurs _after_ successful authentication.
...
## References
  ...
  * [OWASP Key Management Cheat Sheet](../07_令牌、联合身份与密码学/Key_Management_Cheat_Sheet.md)
  * [OWASP Password Storage Cheat Sheet](../05_身份认证与会话管理/Password_Storage_Cheat_Sheet.md)
  * [OWASP Input Validation Cheat Sheet](../02_输入验证、注入与文件处理/Input_Validation_Cheat_Sheet.md)
