...
crosswalk: ASVS V14 | PC C8 | MASVS MASVS-PRIVACY
-->
...
For detailed guides about strong cryptography and best practices, read the following OWASP references:
  1. [Cryptographic Storage Cheat Sheet](../07_令牌、联合身份与密码学/Cryptographic_Storage_Cheat_Sheet.md).
  2. [Authentication Cheat Sheet](../05_身份认证与会话管理/Authentication_Cheat_Sheet.md).
...
For more details regarding HSTS, please visit:
  ...
  3. [OWASP Appsec Tutorial Series - Episode 4: Strict Transport Security](https://www.youtube.com/watch?v=zEV3HOuM_Vw).
...
For details regarding session management, please refer to:
  * [OWASP Session Management Cheat Sheet](../05_身份认证与会话管理/Session_Management_Cheat_Sheet.md).
