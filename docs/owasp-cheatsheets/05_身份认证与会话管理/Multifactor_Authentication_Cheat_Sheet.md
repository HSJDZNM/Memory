...
category: 05_身份认证与会话管理
title: Multifactor Authentication Cheat Sheet
crosswalk: ASVS V6 | PC C6 C7 | Top10 A07
-->
...
| Factor  | Examples  |
| --- | --- |
| [Something You Know](Multifactor_Authentication_Cheat_Sheet.md#something-you-know)  |  [Passwords and PINs](Multifactor_Authentication_Cheat_Sheet.md#passwords-and-pins), [Security Questions](Multifactor_Authentication_Cheat_Sheet.md#security-questions)  |
| [Something You Have](Multifactor_Authentication_Cheat_Sheet.md#something-you-have)  |  [OTP Tokens](Multifactor_Authentication_Cheat_Sheet.md#one-time-password-tokens), [U2F Tokens](Multifactor_Authentication_Cheat_Sheet.md#universal-second-factor), [Certificates](Multifactor_Authentication_Cheat_Sheet.md#certificates),[Smart Cards](Multifactor_Authentication_Cheat_Sheet.md#smart-cards), [Email](Multifactor_Authentication_Cheat_Sheet.md#email), [SMS and Phone Calls](Multifactor_Authentication_Cheat_Sheet.md#sms-messages-and-phone-calls)  |
| [Something You Are](Multifactor_Authentication_Cheat_Sheet.md#something-you-are)  | [Fingerprints, Facial Recognition, Iris Scans](Multifactor_Authentication_Cheat_Sheet.md#biometrics)  |
| [Somewhere You Are](Multifactor_Authentication_Cheat_Sheet.md#somewhere-you-are)  |  [Source IP Address](Multifactor_Authentication_Cheat_Sheet.md#source-ip-address), [Geolocation](Multifactor_Authentication_Cheat_Sheet.md#geolocation), [Geofencing](Multifactor_Authentication_Cheat_Sheet.md#geofencing)  |
| [Something You Do](Multifactor_Authentication_Cheat_Sheet.md#something-you-do)  |  [Behavioral Profiling](Multifactor_Authentication_Cheat_Sheet.md#behavioral-profiling), [Keystroke & Mouse Dynamics](Multifactor_Authentication_Cheat_Sheet.md#keystroke--mouse-dynamics), [Gait Analysis](Multifactor_Authentication_Cheat_Sheet.md#gait-analysis)  |
...
However, the following recommendations are generally appropriate for most applications, and provide an initial starting point to consider.
  ...
  * Provide the option for users to enable MFA on their accounts using [TOTP](Multifactor_Authentication_Cheat_Sheet.md#software-otp-tokens).
  ...
  * Consider [MFA as a service](Multifactor_Authentication_Cheat_Sheet.md#consider-using-a-third-party-service).
...
Having to frequently login with MFA creates an additional burden for users, and may cause them to disable MFA on the application. Risk based authentication can be used to reduce the frequency of MFA prompts, by only requiring MFA when the user is performing an action that is considered to be high risk. Some examples of this include:
  ...
  * Allowing corporate IP ranges (or using [geolocation](Multifactor_Authentication_Cheat_Sheet.md#geolocation) as an additional factor).


#### Passkeys
[Passkeys](https://passkeys.dev/) based on the FIDO2 standard are a new form of MFA that combines characteristics of [possession-based](Multifactor_Authentication_Cheat_Sheet.md#something-you-have) and either [knowledge-based](Multifactor_Authentication_Cheat_Sheet.md#something-you-know) or [inherence-based](Multifactor_Authentication_Cheat_Sheet.md#something-you-are) authentication. The user is required to have a physical device (such as a mobile phone) and to enter a [PIN](Multifactor_Authentication_Cheat_Sheet.md#passwords-and-pins) or use [biometric authentication](Multifactor_Authentication_Cheat_Sheet.md#biometrics) in order to authenticate. The user's device then generates a cryptographic key that is used to authenticate with the server. This is a very secure form of MFA and is resistant to phishing attacks while also being frictionless for the user.
...
There are a number of steps that should be taken when this occurs:
  ...
  * Allow the user to attempt to [reset their MFA](Multifactor_Authentication_Cheat_Sheet.md#resetting-mfa).
...
> [!WARNING] NIST SP 800-63B-4 designates SMS and PSTN-delivered codes as a _restricted_ authenticator because of SS7 interception, SIM-swap, and number-porting attacks. Do not use SMS for high-value or PII-handling applications. Where it is the only available factor, document the risk acceptance, enforce per-account rate limits, monitor for SIM-swap signals, and plan migration to TOTP, push notifications, or WebAuthn/FIDO2.
...
Behavioral profiling is based on the way the user interacts with the application, such as the time of day they log in, the devices they use, and the way they navigate the application. This is rapidly becoming more common in web applications when combined with [Risk Based Authentication](Multifactor_Authentication_Cheat_Sheet.md#risk-based-authentication) and [User and Entity Behavior Analytics](https://learn.microsoft.com/en-us/azure/sentinel/identify-threats-with-entity-behavior-analytics) (UEBA) systems.
#### Pros
...
#### Mitigations
  ...
  * See also: [SMS Messages and Phone Calls](Multifactor_Authentication_Cheat_Sheet.md#sms-messages-and-phone-calls).
