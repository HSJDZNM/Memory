...
crosswalk: ASVS V4 V9 | MASVS MASVS-NETWORK
-->
...
See the [Transport Layer Security Cheat Sheet](../08_传输层、网络与数据保护/Transport_Layer_Security_Cheat_Sheet.md) for additional information.
...
### Validate request content types
  ...
  * For XML content types ensure appropriate XML parser hardening, see the [XXE cheat sheet](../02_输入验证、注入与文件处理/XML_External_Entity_Prevention_Cheat_Sheet.md).
