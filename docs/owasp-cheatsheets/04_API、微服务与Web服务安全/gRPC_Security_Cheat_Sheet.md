<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/gRPC_Security_Cheat_Sheet.html
fetched: 2026-09-16
site: OWASP Cheat Sheet Series (https://cheatsheetseries.owasp.org/)
category: 04_API、微服务与Web服务安全
title: gRPC Security Cheat Sheet
...
Always use prepared statements for database operations to prevent [SQL injection](../02_输入验证、注入与文件处理/SQL_Injection_Prevention_Cheat_Sheet.md).
