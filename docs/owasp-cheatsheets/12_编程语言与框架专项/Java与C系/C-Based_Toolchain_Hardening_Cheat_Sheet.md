<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/C-Based_Toolchain_Hardening_Cheat_Sheet.html
fetched: 2026-09-16
...
`-O`_`n`_sets optimizations for speed or size (for example,`-Os` or `-O2`), and `-g2` ensure debugging information is created.
...
![AdditionalPlatformLibraryMacrosTable](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_AdditionalPlatformLibraryMacrosTable.png)
...
![GCCCWarningOptionsTable](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_GCCCWarningOptionsTable.png)
...
GCC C++ Warning Options table:
![GCCCPPWarningOptionsTable](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_GCCCPPWarningOptionsTable.png)
...
![GCCObjectiveCWarningOptionsTable](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_GCCObjectiveCWarningOptionsTable.png)
...
![XCode1](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_XCode1.png)
### Visual Studio
...
![VStudioWarningOptionsTable](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_VStudioWarningOptionsTable.png)
...
![XCode2](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_XCode2.png)
...
![Windows1](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_Windows1.png)
...
![Windows2](https://cheatsheetseries.owasp.org/assets/C-Based_Toolchain_Hardening_Windows2.png)
