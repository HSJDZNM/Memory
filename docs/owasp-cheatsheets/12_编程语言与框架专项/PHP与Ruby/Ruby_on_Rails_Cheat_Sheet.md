<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/Ruby_on_Rails_Cheat_Sheet.html
fetched: 2026-09-16
...
There is an [Session Management Cheat Sheet](../../05_身份认证与会话管理/Session_Management_Cheat_Sheet.md).
### Authentication
...
There is an [Authentication Cheat Sheet](../../05_身份认证与会话管理/Authentication_Cheat_Sheet.md).
...
More general information about this class of vulnerability is in [OWASP Top 10:2025 A01 Broken Access Control](https://owasp.org/Top10/2025/A01_2025-Broken_Access_Control/) and the [Insecure Direct Object Reference Prevention Cheat Sheet](../../06_授权与访问控制/Insecure_Direct_Object_Reference_Prevention_Cheat_Sheet.md).
...
There is a more general OWASP resource about [unvalidated redirects and forwards](../../03_Web前端与浏览器安全/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.md).
...
## Related Articles and References
  ...
  * [The Ruby Security Reviewers Guide](https://code.google.com/p/ruby-security/wiki/Guide)
