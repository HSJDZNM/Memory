<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/XS_Leaks_Cheat_Sheet.html
fetched: 2026-09-16
site: OWASP Cheat Sheet Series (https://cheatsheetseries.owasp.org/)
category: 03_Web前端与浏览器安全
title: Cross-site leaks Cheat Sheet
...
## Attack vector
![XS Leaks Attack Vector](https://cheatsheetseries.owasp.org/assets/XS_Attack_Vector.png)
...
SameSite cookies are a strong **defense-in-depth** mechanism against **some** classes of XS Leaks and [CSRF attacks](Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.md), which can significantly reduce the attack surface, but may not completely cut them (see, e.g., [window-based XS Leak](https://soheilkhodayari.github.io/same-site-wiki/docs/attacks/xs-leaks.html) attacks like [frame counting](https://xsleaks.dev/docs/attacks/frame-counting/) and [navigation](https://xsleaks.dev/docs/attacks/navigations/)).
### How do we know that two sites are SameSite?
![XS Leaks eTLD explanation](https://cheatsheetseries.owasp.org/assets/XS_Leaks_eTLD.png)
...
![XS-Leaks-ID](https://cheatsheetseries.owasp.org/assets/XS_Leaks_ID.png)
...
Setting up framing protection efficiently blocks the ability to embed your application in a frame on the attacker-controlled origin and protects from other attacks like [Clickjacking](Clickjacking_Defense_Cheat_Sheet.md).
...
![XS Leaks Sec-Fetch-Dest](https://cheatsheetseries.owasp.org/assets/XS_Leaks_Sec_Fetch_Dest.png)
...
![XS-Leaks-Frame-Counting](https://cheatsheetseries.owasp.org/assets/XS_Leaks_Frame_Counting.png)
...
![XS Leaks Cache Attack](https://cheatsheetseries.owasp.org/assets/XS_Leaks_Cache_Attack.png)
...
## Quick recommendations
  * If your application uses cookies, make sure to set the appropriate [SameSite attribute](XS_Leaks_Cheat_Sheet.md#samesite-cookies).
  * Think about whether you really want to allow your application to be embedded in frames. If not, consider using the mechanisms described in the [framing protection](XS_Leaks_Cheat_Sheet.md#framing-protection) section.
  * To strengthen the isolation of your application between other origins, use [Cross Origin Resource Policy](XS_Leaks_Cheat_Sheet.md#cross-origin-resource-policy-corp) and [Cross Origin Opener Policy](XS_Leaks_Cheat_Sheet.md#cross-origin-opener-policy-coop) headers with appropriate values.
