...
## Strict CSP
A strict CSP can be created by using a limited number of the granular [Fetch Directives listed below](Content_Security_Policy_Cheat_Sheet.md#fetch-directives) along with one of two mechanisms:
  * Nonce based
  * Hash based
