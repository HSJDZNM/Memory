...
POST /addUser
...
userid=bobbytables&password=hashedpass&[email protected][](https://cheatsheetseries.owasp.org/cdn-cgi/l/email-protection)
...
POST /addUser
...
userid=bobbytables&password=hashedpass&[email protected][](https://cheatsheetseries.owasp.org/cdn-cgi/l/email-protection)&isAdmin=true
...
Take a look [here](https://www.baeldung.com/jackson-field-serializable-deserializable-or-not) and [here](https://lifelongprogrammer.blogspot.com/2015/09/using-jackson-view-to-protect-mass-assignment.html) for the documentation.
