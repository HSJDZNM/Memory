...
crosswalk: ASVS V1 | PC C4 | Top10 A03
-->
...
Data Type: String Context: DOM XSS Code: `<script>document.write("UNTRUSTED INPUT: " + document.location.hash );<script/>` Sample Defense: [DOM based XSS Prevention Cheat Sheet](DOM_based_XSS_Prevention_Cheat_Sheet.md) |
...
The following article describes how attackers can exploit different kinds of XSS vulnerabilities (and this article was created to help you avoid them):
  * OWASP: [XSS Filter Evasion Cheat Sheet](XSS_Filter_Evasion_Cheat_Sheet.md).
