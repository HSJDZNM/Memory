...
For examples of why this is dangerous, see the links in the [Other resources](Prototype_Pollution_Prevention_Cheat_Sheet.md#other-resources) section below.
