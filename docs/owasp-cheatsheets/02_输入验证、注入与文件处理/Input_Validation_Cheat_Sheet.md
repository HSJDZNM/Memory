...
crosswalk: ASVS V1 V2 V5 | PC C5 | MASVS MASVS-CODE
-->
...
The links that are sent to users to prove ownership should contain a token that is:
  ...
  * Generated using a [secure source of randomness](../07_令牌、联合身份与密码学/Cryptographic_Storage_Cheat_Sheet.md#secure-random-number-generation).
  * Single use.
