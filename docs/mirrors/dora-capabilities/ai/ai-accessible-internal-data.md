...
source_url: "https://dora.dev/capabilities/ai-accessible-internal-data/"
section: "ai"
...
Many teams are familiar with _prompt engineering_ (writing a specific command). To unlock real value, organizations must start iterating to context engineering.
...
![Prompt engineering vs context engineering](https://dora.dev/capabilities/ai-accessible-internal-data/prompt-vs-context.svg)Prompt engineering vs context engineering
...
This capability is the bridge between “using AI” and “getting value from AI.”
  ...
  * **Risks**
    * **Delivery instability:** Rapid code generation can harm stability if [small batch sizes](../core/working-in-small-batches.md) are ignored.
...
Don’t rely on massive context windows to handle irrelevant data. Overloading the model dilutes the signal and leads to hallucinations.
  ...
  * **Mitigation:** Focus on relevance, not volume. Use RAG or MCP to retrieve only the specific _chunks_ of relevant data (a practice emerging as “context harvesting”).
...
DORA research measured this capability by asking a [specific set of questions regarding frequency of use, access levels, and context relevance](https://dora.dev/ai/capabilities-model/questions/#ai-accessible-internal-data).
