...
source_url: "https://dora.dev/capabilities/visual-management/"
section: "unlabeled"
role: "能力文档 · 站点未标注模型归属"
...
When combined with the use of [WIP limits](wip-limits.md) and using feedback from production to make business decisions, visual management displays can contribute to [higher levels of delivery performance](https://dora.dev/research/2015/2015-state-of-devops-report.pdf#page=15) (PDF).
...
The goal of visual management tools is to provide fast, easy-to-understand feedback so you can build quality into the product. This feedback helps the team identify defects in the product and understand whether some part of the system is not performing effectively, which helps them address the problem. In order to be effective, such systems must do the following:
  ...
  * **Be easy to understand**. It should be possible to tell at a glance from across the room whether something needs attention. If there _is_ a problem, teams should know how to perform further diagnosis or fix the problem.
...
## What’s next
  ...
  * Read the book [_Making Work Visible_](https://itrevolution.com/book/making-work-visible/), by Dominica DeGrandis.
