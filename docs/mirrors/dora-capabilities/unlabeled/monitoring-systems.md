...
source_url: "https://dora.dev/capabilities/monitoring-systems/"
section: "unlabeled"
role: "能力文档 · 站点未标注模型归属"
...
When you transform and visualize the collected data, you make it accessible to different audiences and help them make decisions. For example, you might want to share operations data upstream.You can also integrate this data as appropriate into reports and briefings, and use it in meetings to make informed business decisions. In this case, _appropriate_ means relevant, timely, accurate, and easy to understand.
