...
| --- | --- | --- |
| # 1  | Use HTML Sanitizers  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#1-html-sanitization)  |
| # 2  | Use Content-Security Policy  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#2-content-security-policy)  |
| # 3  | Freeze Sensitive DOM Objects  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#3-freezing-sensitive-dom-objects)  |
| # 4  | Validate All Inputs to DOM Tree  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#4-validate-all-inputs-to-dom-tree)  |
| # 5  | Use Explicit Variable Declarations  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#5-use-explicit-variable-declarations)  |
| # 6  | Do Not Use Document and Window for Global Variables  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#6-do-not-use-document-and-window-for-global-variables)  |
| # 7  | Do Not Trust Document Built-in APIs Before Validation  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#7-do-not-trust-document-built-in-apis-before-validation)  |
| # 8  | Enforce Type Checking  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#8-enforce-type-checking)  |
| # 9  | Use Strict Mode  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#9-use-strict-mode)  |
| # 10  | Apply Browser Feature Detection  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#10-apply-browser-feature-detection)  |
| # 11  | Limit Variables to Local Scope  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#11-limit-variables-to-local-scope)  |
| # 12  | Use Unique Variable Names In Production  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#12-use-unique-variable-names-in-production)  |
| # 13  | Use Object-oriented Programming Techniques like Encapsulation  | [link](DOM_Clobbering_Prevention_Cheat_Sheet.md#13-use-object-oriented-programming-techniques-like-encapsulation)  |
...
Before inserting any markup into the webpage's DOM tree, sanitize `id` and `name` attributes (see [HTML sanitization](DOM_Clobbering_Prevention_Cheat_Sheet.md#1-html-sanitization)).
