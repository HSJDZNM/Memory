...
Also see the [Secrets Management](../../07_令牌、联合身份与密码学/Secrets_Management_Cheat_Sheet.md) cheat sheet for more details and best practices on managing secrets.
...
```
{
  ...
  "verb":"list",
  "user": {
    "username":"[email protected][](https://cheatsheetseries.owasp.org/cdn-cgi/l/email-protection)",
...
* * *
![Kubernetes Architecture](https://cheatsheetseries.owasp.org/assets/Kubernetes_Architecture.png)
## References
