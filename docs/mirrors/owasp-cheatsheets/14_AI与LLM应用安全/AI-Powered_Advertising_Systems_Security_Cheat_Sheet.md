<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/AI-Powered_Advertising_Systems_Security_Cheat_Sheet.html
fetched: 2026-09-16
site: OWASP Cheat Sheet Series (https://cheatsheetseries.owasp.org/)
category: 14_AI与LLM应用安全
title: AI-Powered Advertising Systems Security Cheat Sheet
...
Every outcome callback is money and a training label in one packet.
  ...
  * Tier every agentic tool by risk. HITL (human-in-the-loop) approvals bind a six-tuple: actor, tool, target, normalized parameters, timestamp, expiry ([OWASP LLM06:2025 Excessive Agency](https://genai.owasp.org/llmrisk/llm062025-excessive-agency/)). Generic agentic patterns in the [OWASP AI Agent Security Cheat Sheet](AI_Agent_Security_Cheat_Sheet.md).
...
**Generic mechanics defer to:**
  ...
  * [OWASP RAG Security Cheat Sheet](RAG_Security_Cheat_Sheet.md)
  * [OWASP AI Agent Security Cheat Sheet](AI_Agent_Security_Cheat_Sheet.md)
  * [OWASP Secure AI/ML Model Ops Cheat Sheet](Secure_AI_Model_Ops_Cheat_Sheet.md)
  * [OWASP JSON Web Token Cheat Sheet](../07_令牌、联合身份与密码学/JSON_Web_Token_Cheat_Sheet.md)
  * [OWASP Content Security Policy Cheat Sheet](../03_Web前端与浏览器安全/Content_Security_Policy_Cheat_Sheet.md)
