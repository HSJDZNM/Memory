<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/Secure_Product_Design_Cheat_Sheet.html
fetched: 2026-09-16
...
Details of how to precisely ensure secure configuration can be found in [Infrastructure as Code Security Cheat Sheet](../13_云原生、容器与基础设施/CI-CD与IaC/Infrastructure_as_Code_Security_Cheat_Sheet.md)
