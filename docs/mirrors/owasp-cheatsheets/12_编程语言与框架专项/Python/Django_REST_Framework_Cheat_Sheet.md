<!--
source: https://cheatsheetseries.owasp.org/cheatsheets/Django_REST_Framework_Cheat_Sheet.html
fetched: 2026-09-16
site: OWASP Cheat Sheet Series (https://cheatsheetseries.owasp.org/)
category: 12_编程语言与框架专项/Python
title: Django REST Framework (DRF) Cheat Sheet
...
### Secret Management
**Secrets should never be hardcoded. The best practice is to use a Secret Manager.** For more information review OWASP [Secrets Management Cheat Sheet](../../07_令牌、联合身份与密码学/Secrets_Management_Cheat_Sheet.md)
...
--Every month/quarter dependencies in general are updated. --Every week important security vulnerabilities are considered and potentially trigger an update. --In EXCEPTIONAL conditions, emergency updates may need to be applied.
