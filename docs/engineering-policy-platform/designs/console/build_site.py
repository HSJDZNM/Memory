...
数据来自仓库真实文件，重建：python docs/engineering-policy-platform/designs/console/build_site.py
"""
...
def load_data() -> dict:
    ...
    for manifest in sorted(ROOT.glob("docs/*/manifest.json")):
        try:
...
def page_authoring(data: dict) -> str:
    ...
    return (
        ...
        '<input type="text" id="source-path" placeholder="docs/<mirror>/<page>/index.md">\n'
