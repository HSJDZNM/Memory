...
```powershell
python -m http.server 8099 --directory docs/engineering-policy-platform/designs/console
...
```powershell
$env:PYTHONPATH = "src"
python docs/engineering-policy-platform/designs/console/build_site.py
```
