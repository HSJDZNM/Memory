...
| 数据集 | 可用于本项目的内容 | 首选入口 |
| --- | --- | --- |
| Google Engineering Practices | 设计、功能、复杂度、测试、文档、变更规模与评审质量 | [评审关注点](../google-eng-practices/review/reviewer/looking-for.md)、[小变更](../google-eng-practices/review/developer/small-cls.md) |
| GitLab Code Review | 质量、可靠性、可观测性、安全、部署、合规的验收清单 | [Code Review Guidelines](../gitlab-code-review/development/code_review/index.md) |
| GitLab 专项规范 | 权限规则的 source of truth、AI 指令文件评审和领域专项检查 | [授权评审](../gitlab-code-review/development/permissions/review_guidelines/index.md)、[AI 指令文件评审](../gitlab-code-review/development/ai_instruction_files_review/index.md) |
| OWASP Cheat Sheet Series | Agent、RAG、MCP、Secrets、日志、输入验证、授权与供应链安全 | [AI Agent](../owasp-cheatsheets/14_AI与LLM应用安全/AI_Agent_Security_Cheat_Sheet.md)、[RAG](../owasp-cheatsheets/14_AI与LLM应用安全/RAG_Security_Cheat_Sheet.md)、[MCP](../owasp-cheatsheets/14_AI与LLM应用安全/MCP_Security_Cheat_Sheet.md) |
| Python PEP | Python 排版、命名、导入、文档字符串和公共接口约定 | [PEP 8](../python-pep-code-style/pep-8-python-code/index.md)、[PEP 257](../python-pep-code-style/pep-257-docstrings/index.md) |
| .NET Design Guidelines | API 命名、类型、成员、异常和扩展性规则 | [.NET 指南入口](../dotnet-design-guidelines/index.md) |
| DORA Capability Model | 变更审批、小批量、测试自动化、持续集成、可维护性、文档、安全、可观测性等交付能力（CC BY 4.0） | [能力目录](../dora-capabilities/index.md) |
